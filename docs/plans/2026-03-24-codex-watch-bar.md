...
- Create: `Sources/CodexWatchCore/`
- Create: `Sources/CodexWatch/main.swift`
- Create: `Tests/CodexWatchCoreTests/`
...
Run: `swift test`
Expected: FAIL because `CodexWatchCore` and `AppConstants` do not exist yet.
...
.testTarget(name: "CodexWatchCoreTests", dependencies: ["CodexWatchCore"])
```
...
**Files:**
- Create: `Sources/CodexWatchCore/Auth/AuthSource.swift`
- Create: `Sources/CodexWatchCore/Auth/AuthDiscovery.swift`
- Create: `Sources/CodexWatchCore/Models/UsageSnapshot.swift`
- Create: `Sources/CodexWatchCore/Parsing/UsageResponseParser.swift`
- Test: `Tests/CodexWatchCoreTests/AuthDiscoveryTests.swift`
- Test: `Tests/CodexWatchCoreTests/UsageResponseParserTests.swift`
...
```bash
git add Sources/CodexWatchCore Tests/CodexWatchCoreTests
...
**Files:**
- Create: `Sources/CodexWatchCore/Networking/UsageRequestBuilder.swift`
- Create: `Sources/CodexWatchCore/Networking/UsageClient.swift`
- Create: `Sources/CodexWatchCore/Refresh/RefreshCoordinator.swift`
- Test: `Tests/CodexWatchCoreTests/UsageRequestBuilderTests.swift`
- Test: `Tests/CodexWatchCoreTests/RefreshCoordinatorTests.swift`
...
**Files:**
- Create: `Sources/CodexWatch/App/AppDelegate.swift`
- Create: `Sources/CodexWatch/App/MenuBarController.swift`
- Create: `Sources/CodexWatch/UI/MenuContentView.swift`
- Create: `Sources/CodexWatch/UI/SettingsView.swift`
- Create: `Sources/CodexWatch/UI/IconRenderer.swift`
...
```bash
git add Sources/CodexWatch Tests/CodexWatchCoreTests
...
**Files:**
- Create: `Sources/CodexWatchCore/Auth/OAuthSession.swift`
- Create: `Sources/CodexWatchCore/Auth/KeychainTokenStore.swift`
- Create: `Sources/CodexWatch/App/LoginItemManager.swift`
- Modify: `Sources/CodexWatch/UI/SettingsView.swift`
- Create: `README.md`
- Test: `Tests/CodexWatchCoreTests/KeychainTokenStoreTests.swift`
...
func testPrefersKeychainOauthWhenNoLocalAuthExists() throws {
    ...
    XCTAssertEqual(try resolver.resolve(), .oauthKeychain(service: "CodexWatch", account: "default"))
}
```
