...
- `CodexWatchCore` holds auth discovery, OAuth persistence, request building, endpoint parsing, refresh logic, and view models.
- `CodexWatch` owns the menu bar status item, SwiftUI views, app lifecycle, and settings window.
